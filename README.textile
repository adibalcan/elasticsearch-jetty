...
Usually ES is installed at /usr/share/elasticsearch/ so the command is:
<pre>
/usr/share/elasticsearch/bin/plugin -url https://oss-es-plugins.s3.amazonaws.com/elasticsearch-jetty/elasticsearch-jetty-1.2.1.zip -install elasticsearch-jetty-1.2.1
</pre>
